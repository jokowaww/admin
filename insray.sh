...
sleep 1
wget -q -O xraymode.sh https://autoscript.wongedankuwibebas.my.id/xraymode.sh && chmod +x xraymode.sh && ./xraymode.sh
sleep 1 
wget -q -O /etc/xray/config.json "https://autoscript.wongedankuwibebas.my.id/config.json"
chmod +x /etc/xray/config.json
sleep 1 
rm -f /etc/nginx/conf.d/xray.conf
wget -q -O /etc/nginx/conf.d/xray.conf "https://autoscript.wongedankuwibebas.my.id/xray.conf"
...
#LIMIT QUOTA
wget -q -O /usr/local/sbin/quota "https://autoscript.wongedankuwibebas.my.id/quota.sh"
